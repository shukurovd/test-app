                    ...
                    <div class="p-6 text-gray-900">
                        <div class="block w-full overflow-x-auto">
                            <form action="{{ route('companies.store') }}" method="POST">
                                ...
                                <input type="text" name="name"  required class="p-3 mt-2 mb-4 w-full bg-slate-200 rounded border-2 border-slate-200 focus:border-slate-600 focus:outline-none">
                                <label class="uppercase text-sm font-bold opacity-70">Address</label>
                                <input type="text" name="address"  required class="p-3 mt-2 mb-4 w-full bg-slate-200 rounded border-2 border-slate-200 focus:border-slate-600 focus:outline-none">
